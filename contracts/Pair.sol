...
/**
 * @title Pair
 * @notice AMM constant-product liquidity pool (Uniswap v2 style).
 *         Formula: x * y = k
 *         Fee: 0.3% per swap (997/1000)
...
contract Pair is ERC20, ReentrancyGuard {
    ...
    constructor() ERC20("WEBD LP Token", "WEBD-LP") {
        factory = msg.sender;
    }
    ...
    /**
     * @notice Add liquidity. Tokens must be transferred to this contract before calling.
    ...
    function mint(address to) external nonReentrant returns (uint256 liquidity) {
        ...
        if (_totalSupply == 0) {
            ...
            // Permanently lock first MINIMUM_LIQUIDITY tokens to address(1) — protects against manipulation
    ...
    /**
     * @notice Remove liquidity. LP tokens must be transferred to this contract before calling.
    ...
    /**
     * @notice Execute a swap. Tokens to receive must be specified; counterparty tokens
     *         must already be transferred to this contract.
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to) external nonReentrant {
        ...
        // Verify k invariant with 0.3% fee applied
    ...
    /**
     * @notice Force-sync reserves to match actual token balances.
     */
